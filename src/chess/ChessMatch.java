...
public class ChessMatch {
	...
	private void initialSetup() {
		...
		placeNewPiece('d',2,  new Rook(board, color));
		placeNewPiece('f',1,  new Rook(board, color));
		placeNewPiece('f',2,  new Rook(board, color));
		placeNewPiece('e',2,  new Rook(board, color));
		placeNewPiece('e',1,  new King(board, color));
		
		
		color = Color.BLACK;
		placeNewPiece('d',8,  new Rook(board, color));
		placeNewPiece('d',7,  new Rook(board, color));
		placeNewPiece('f',8,  new Rook(board, color));
		placeNewPiece('f',7,  new Rook(board, color));
		placeNewPiece('e',7,  new Rook(board, color));
